...
Player.prototype.update = function(deltaTime)
{
	...
	this.velocity.x = bound(this.velocity.x + (deltaTime * accelerationx), -MAXDX, MAXDX);
	this.velocity.y = bound(this.velocity.y + (deltaTime * accelerationy), -MAXDY, MAXDY);
	...
	////////////////////////////////////////////////////////////////////////////////
	////getting out tiles closest to the player
	...
	if (this.velocity.y > 0)
	{
		...
		if ((celldown && !cell) || (celldiag && !cellright && nx))
		{
			...
			this.falling = false;
			this.jumping = false;
			ny = 0; //no longer overlapping the sell below
		}
	}
	//upwards
